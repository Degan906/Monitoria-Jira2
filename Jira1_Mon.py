...
card_links = {
   ...
   "⏫ PB Finalizados":"https://carboncars.atlassian.net/issues/?jql=project%20%3D%20PB%20and%20status%20%3D%20%22114.2%20-%20Finalizado%20Prepara%C3%A7%C3%A3o%20Entrega%22",
    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                ...
                "⏫ PB Finalizados": 'project = PB and status = "114.2 - Finalizado Preparação Entrega"',
