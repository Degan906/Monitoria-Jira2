...
card_tooltips = {
    ...
    "PB Ag.Limpeza QA1": "🔍 Verifica issues do projeto PB que estão no status 🟡 '135 - Aguardando Limpeza QA1' e são do tipo 🧱 'Produção Blindados'. Útil para monitorar itens parados nesta etapa de limpeza da QA1.",
    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                ...
                "AP Data Exército": 'project = AP and issuetype = Recebimento and status = "Aguardando entrada" and "Data de Liberação do Exército[Date]" is not empty and summary !~ TESTE',
                ...
                "PB-Prazo Contrato vazia": 'project = PB and type in ("Produção Blindados", "Produção Blindados - QA") and "Prazo Contrato[Short text]" is empty and created >= 2024-02-01',
                ...
                "Monitoria de processo Incidentes": 'project IN (JSM, SUPORTE) AND type IN ("[System] Incident", Monitoria) AND resolution = Unresolved AND labels = ⚠️MONITORIA⚠️ and statusCategory = "To Do"',
                "Incidentes Sistemas": 'project IN (JSM, SUPORTE) AND type IN ("[System] Incident") AND resolution = Unresolved and statusCategory = "To Do" and Sistema = Jira', 
