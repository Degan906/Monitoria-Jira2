...
card_tooltips = {
   ...
   "⏫ PB_Finalizados": 'PB parado em 114.2 - Finalizado Preparação e Entrega - Deveria sair do 114.2 e ir para o 140 - Aguardando Repasse de Saída JQL: project = PB and status = "114.2 - Finalizado Preparação Entrega"',
...
card_links = {
   ...
   "🔽 RNC != Vidro":"https://carboncars.atlassian.net/issues/?jql=project%20%3D%20RNC%20and%20status%20%3D%20%22Em%20Produ%C3%A7%C3%A3o%20Carbon%22%20and%20issuelinktype%20not%20in%20%28%22RNC%20%3E%20Vidro%22%29",
   ...
   "⏫ PB_Finalizados":"https://carboncars.atlassian.net/issues/?jql=project%20%3D%20PB%20and%20status%20%3D%20%22114.2%20-%20Finalizado%20Prepara%C3%A7%C3%A3o%20Entrega%22",
    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                ...
                "⏫ PB_Finalizados": 'project = PB and status = "114.2 - Finalizado Preparação Entrega"',
