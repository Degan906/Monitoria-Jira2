...
card_links = {
   ...
   "⏫ Compras Paarados":"https://carboncars.atlassian.net/issues/?jql=project%20%3D%20PB%20and%20status%20changed%20from%20%2212%20-%20Aguardando%20Valida%C3%A7%C3%B5es%22%20to%20%22132.1%20-%20Laudo%20Conclu%C3%ADdo%22%20and%20status%20%3D%20%22132.1%20-%20Laudo%20Conclu%C3%ADdo%22",
    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                ...
                "⏫ Compras Paarados": 'resolution = Unresolved AND project = COM AND status IN ("Aguardando aprovação Diretoria", "Aguardando Comite") and "Request Type" in ("Vidros (COM)", "RNC (COM)", "Assistência Técnica-Vidros (COM)", "MP e Insumos - Opera") and "Empresa[Dropdown]" = "Carbon Assistência"',
