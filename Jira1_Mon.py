             ...
             if response.status_code == 200:
                 ...
                 with cols[i % num_columns]:
                     background = (
                         ...
                         '<div style="border: 1px solid #ddd; border-radius: 5px; padding: 5px; text-align: center; width: 100px; height: 100px; display: flex; flex-direction: column; justify-content: center; align-items: center; margin: 10px;" '
