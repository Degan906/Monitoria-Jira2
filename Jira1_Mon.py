...
# CSS para tooltips gerais e animações dos cards
st.markdown("""
<style>
.tooltip {
    position: relative;
...
if not st.session_state.authenticated:
    ...
    # Estilo CSS adicional para o tooltip da barra de status
    st.markdown("""
    <style>
    .tooltip-status {
        position: relative;
    ...
    # Barra de status no topo da tela com tooltip estilizado
    status_bar = st.empty()
        ...
        status_bar.markdown(
            ...
            <div style="background-color: #f0f0f0; padding: 10px; text-align: center; border-radius: 5px; margin-bottom: 10px;">
                ...
                <div class="tooltip-status">
                    <strong>V4.7</strong>
                    <span class="tooltiptext-status">
                        - Adição dos tooltips detalhados por card<br>
                        - Inclusão de links clicáveis na legenda<br>
                        - Separação de cards por grupo com ícones<br>
                        - Correções visuais e ajuste no layout<br>
                        - Melhoria no desempenho com cache otimizado
                    </span>
                </div>
            </div>
            """,
