    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                ...
                "⏫ Com Assistencia": 'resolution = Unresolved AND project = COM AND status IN ("Aguardando aprovação Diretoria", "Aguardando Comite") and "Request Type" in ("Vidros (COM)", "RNC (COM)", "Assistência Técnica-Vidros (COM)", "MP e Insumos - Opera") and "Empresa[Dropdown]" = "Carbon Assistência"',
            },
        }
